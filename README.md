# nomad-pv-stability-measurements

data schema for ingesting stability measurments on pv according to different measurement protocals (standardized and custom)
...
```sh
git clone https://github.com/HU Berlin/nomad-pv-stability-measurements.git
cd nomad-pv-stability-measurements
...
| Name | E-mail     |
|------|------------|
| Simon Ternes | [john.doe@physik.hu-berlin.de](mailto:john.doe@physik.hu-berlin.de)
